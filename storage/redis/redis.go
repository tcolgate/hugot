// Package redis implements a hugot Store that is backed by
// a redis database using gopkg.in/redis.v5
package redis
...
// New creates a new store with the provided gopkg.in/redis.v5
// options.
